...
export default function Navbar() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 border-b border-[#efe7df] bg-[#fffaf6]/90 backdrop-blur-xl">
      ...
      {open && (
        <div id="mobile-menu" className="border-t border-[#efe3da] bg-white md:hidden">
